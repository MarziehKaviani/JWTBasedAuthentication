...
# class ModelTranslationGetSerializer(serializers.ModelSerializer):
#     # def to_representation(self, instance):
#     #     representation = super().to_representation(instance)
#     #     translated_fields = translator.get_options_for_model(self.Meta.model).fields
#     #     for fields_all_languages in translated_fields:
#     #         for field in translated_fields[fields_all_languages]:
#     #             representation.pop(field.name, None)
